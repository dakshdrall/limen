 ...
 * is a constant; here it is a thing a person reads, which is the only form of it
 * that does any work. `test/local-key-label.test.ts` requires that at least one
 * file render it and that every file touching the key name it — this is the
 * first half.
 *
 * It renders beside every signature rather than once at the top of a flow. The
 * claim the whole product makes is that the agent's key cannot exceed a boundary
 * the owner's key installed; a person who cannot see which of the two is signing
 * at the moment it signs has been asked to take that on trust.
 *
 ...
 * the V6 rebuild deleted the component. The vocabulary is content; this is
 * markup; both are consumers.
 */
  ...
  return (
    <div className="flex flex-col gap-1.5">
      <div className="flex flex-wrap items-center gap-2">
        <span className="font-mono text-[11px] tracking-[0.08em] text-muted uppercase">{role}</span>
